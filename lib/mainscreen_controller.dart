...
Widget myIcons({String? svgAssetUrl, double? width, double? height, Color? color}) {
  return SvgPicture.asset(
    ...
    colorFilter: ColorFilter.mode(color??AppColors.iconColor, BlendMode.srcIn),
  );}
...
List<BottomNavigationBarItem> getItems() {
    return [
     BottomNavigationBarItem(
        activeIcon:myIcons(svgAssetUrl: AppIcons.home,
     ...
     BottomNavigationBarItem(
         icon: myIcons(svgAssetUrl: AppIcons.searchBorder),
           activeIcon:myIcons(svgAssetUrl: AppIcons.search,
        color:AppColors.appColorPrimary,
        ), label: 'Search'
        // activeIcon: Icon(
     ...
     BottomNavigationBarItem(
         icon: myIcons(svgAssetUrl: AppIcons.plusBorder),
           activeIcon:myIcons(svgAssetUrl: AppIcons.plus,
        color:AppColors.appColorPrimary,
        ), label: 'Add'
      // activeIcon: Icon(
     ...
     BottomNavigationBarItem(
         icon: myIcons(svgAssetUrl: AppIcons.heartBorder),
           activeIcon:myIcons(svgAssetUrl: AppIcons.heart,
        color:AppColors.appColorPrimary,
        ), label: 'Activity'
      // activeIcon: Icon(
      //     Iconsax.heart5,
     ...
     BottomNavigationBarItem(
         icon: myIcons(svgAssetUrl: AppIcons.userBorder),
           activeIcon:myIcons(svgAssetUrl: AppIcons.user,
        color:AppColors.appColorPrimary,
        ), label: 'Profile'
      // activeIcon: Icon(
