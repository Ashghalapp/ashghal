...
iconTheme: const IconThemeData(color: AppColors.iconColorPrimaryDark),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    focusedBorder: const OutlineInputBorder(
      borderSide: BorderSide(color: AppColors.appColorPrimary, width: AppSize.s1_5),
      borderRadius: BorderRadius.all(Radius.circular(AppSize.s8)),
    ),
    errorBorder: OutlineInputBorder(
  ...
  colorScheme: const ColorScheme.dark(primary: AppColors.appColorPrimary).copyWith(error: Colors.red),
).copyWith(
  colorScheme: ColorScheme.fromSwatch().copyWith(secondary: AppColors.appColorPrimary),
);
