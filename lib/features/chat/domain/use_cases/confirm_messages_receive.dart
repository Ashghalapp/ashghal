...
// class ConfirmMessagesReceive {
//   final MessageRepository repository;
//   ConfirmMessagesReceive({
//     required this.repository,
//   });

//   Future<Either<Failure, RecieveReadConfirmation>> call(
//       ReceiveReadConfirmationRequest request) async {
//     return await repository.confirmMessagesRead(request);
//   }
// }
