...
abstract class PostLocalDataSource {
  ...
  void casheRecentPosts(List<PostModel> posts);

  List<Post> getRecentCashedPosts();
}
...
class PostLocalDataSourceImpl implements PostLocalDataSource {
  ...
  static String recentPostsKey = "cached_recent_posts";
  ...
  @override
  void casheRecentPosts(List<PostModel> posts) {
    _cashedPosts(posts, recentPostsKey);
  }

  @override
  List<Post> getRecentCashedPosts() {
    return _getCashedPosts(recentPostsKey);
  }
  ...
  //   print(
  //       ":::::::::::::::::::::Get comment replies from cashe::::::::::::::::::::::");
