    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
            ...
            child: Column(
              children: [
                ...
                AppTextFormField(
                  ...
                  onTap: () async {
                    ...
                    addPostController.expireDateController.text =
                        addPostController.expireDate.value
                            .toString()
                            .split(' ')[0];
                    print(
                        "<<<<<<<${addPostController.expireDate.value}>>>>>>>");
                ...
                AppDropDownButton(
                  ...
                  initialValue: addPostController.selectedCityId.value,
                  items: citiess.map((city) => city.toJson()).toList(),
                  margin: const EdgeInsets.only(top: 5),
                  onChange: addPostController.onCityChangeFunction,
                ),
                ...
                Obx(
                  () => AppDropDownButton(
                    ...
                    initialValue: addPostController.selectedDistrictId.value,
                    margin: const EdgeInsets.only(top: 15),
                    items: addPostController.cityDistricts
                        .map((district) => district.toJson())
                        .toList(),
                    onChange: (newValue) {
                      addPostController.selectedDistrictId.value =
                          int.parse(newValue?.toString() ?? "1");
                    },
                  ),
                ),
          ...
          AppGesterDedector(
            text: isUpdatePost ? AppLocalization.update : AppLocalization.send,
                    ...
                    child:
                      ...
                      child: imageUrl.startsWith('http')
                          ? CashedNetworkImageWidget(
                              ...
                              imageUrl: imageUrl,
                              errorAssetImagePath:
                                  "assets/images/image-loading-failed.png",
                            )
                          : Image.file(
                              File(imageUrl),
                              // width: Get.width - 100,
