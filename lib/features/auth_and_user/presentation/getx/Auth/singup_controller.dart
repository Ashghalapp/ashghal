...
// RxString selectedItem = 'Item 1'.obs;
  ...
  final Map<int, List<Map<String, Object>>> cityDistricts = {
    ...
    1: [
      ...
      {'id': 20, 'name_ar': 'مديرية بني الحارث','name_en': 'Bani Al-Harith District'},
      {
        'id': 21,
    ...
    {'id': 19, 'name_ar': 'حورة ووادي العين', 'name_en': 'Hurah and Wadi Al-Ayn'},
 ...
 16:[  
  ...
  17: [
    ...
    {'id': 5, 'name_ar': 'المضاربة والعارة', 'name_en': 'Al-Mudarbah wal-\'Arah'},
...
// get the user location
  ...
  Future<Either<Failure, User>> sendSignUpUserRequest(String verficationCode,
    ...
    RegisterUserRequest request = RegisterUserRequest.withEmail(
      ...
      address: Address.addRequest(city: cities.firstWhere((element) => element['id']==selectedCity)['name_en'].toString(),district: (cityDistricts[selectedCity]!.firstWhere((element) => element['id']==selectedDistrict)['name_en']).toString() )
    );
